<template>
  <div class="notfound-page">
    ...
    <div class="notfound-actions">
      <router-link to="/" class="notfound-link">返回首页</router-link>
      <button type="button" class="notfound-link notfound-link-secondary" @click="goBack">
        返回上一页
      </button>
    </div>
  </div>
...
.notfound-link {
  ...
  color: #fff7ef;
  font-weight: 700;
  box-shadow: 0 10px 18px rgba(29, 14, 1, 0.15);
...
.notfound-link:hover {
  ...
  box-shadow: 0 14px 24px rgba(29, 14, 1, 0.2);
}
